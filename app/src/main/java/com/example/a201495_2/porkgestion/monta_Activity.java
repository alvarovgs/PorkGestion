...
public class monta extends AppCompatActivity {
    ...
    public void registromonta(View v) {
        EditText et1 = (EditText)findViewById(R.id.id_hembra);
        String rmonta = et1.getText().toString();
        if (!clsUtil.bValidaString(rmonta,1)){
            Toast.makeText(this, "Ingresar ID de Hembra",Toast.LENGTH_SHORT).show();
        }
        objmonta = new reproduccion (getApplicationContext());
        objmonta.getreproduccion(rmonta);
        EditText et2 = (EditText)findViewById(R.id.fechacelo);
        EditText et3 = (EditText)findViewById(R.id.edtxt_fechaprimercelo);
        et2.setText(objmonta.getStrOrigen());
        et3.setText(objmonta.getStrDescripcion());
