...
public class ReporteProduccionActivity extends AppCompatActivity {
    ...
    private void consultarCerdos(){
        try {
            ...
            Toast.makeText(getApplicationContext(), "Error consultando datos generales", Toast.LENGTH_SHORT).show();
        }
    }
    private void consultarVentas(String strFechaI, String strFechaF){
        try {
            ...
            Toast.makeText(getApplicationContext(), "Error consultando datos de venta", Toast.LENGTH_SHORT).show();
        }
    }
    private void consultarPartos(String strFechaI, String strFechaF){
        try {
            ...
            Toast.makeText(getApplicationContext(), "Error consultando datos de parto", Toast.LENGTH_SHORT).show();
        }
    }
