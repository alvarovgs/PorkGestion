...
public class reporteventa extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        campoIdConsuVe= (EditText) findViewById(R.id.et_numa);
        campoNomConsuVe= (EditText) findViewById(R.id.et_nomba);
        campoFeConsuVe= (EditText) findViewById(R.id.et_feve);
        campoPeConsuVe=(EditText) findViewById(R.id.et_pesoven);
        campoPreConsuVe=(EditText) findViewById(R.id.et_preven);
    }

    public void onClick(View view) {

        switch (view.getId()){
            case R.id.bt_consultar: consultar();
                break;
        }
    }
